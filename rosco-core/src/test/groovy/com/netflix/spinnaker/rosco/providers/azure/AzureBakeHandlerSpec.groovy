  ...
  void 'can scrape packer logs for image name'() {
    ...
    when:
      def logsContent =
        ...
        "OSDiskUriReadOnlySas: https://lgpackervms.blob.core.windows.net/system/Microsoft.Compute/Images/images/packer-osDisk.0425d8dd-45a0-4f2e-aabb-b5f9a03b08c9.vhd?se=2016-06-24T18%3A16%3A46Z&sig=***REMOVED***&sp=r&sr=b&sv=2015-02-21"
